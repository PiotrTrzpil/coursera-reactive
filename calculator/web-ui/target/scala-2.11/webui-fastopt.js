...
$c_Lcalculator_Calculator$.prototype.eval$1__p1__Lcalculator_Expr__T__sci_Map__D = (function(expr, rootName$1, references$1) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var refer = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references$1);
      expr = ((name === rootName$1) ? new $c_Lcalculator_Literal().init___D((NaN)) : refer);
      continue _eval
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(a, rootName$1, references$1) + this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(b, rootName$1, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(a$2, rootName$1, references$1) - this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(b$2, rootName$1, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(a$3, rootName$1, references$1) * this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(b$3, rootName$1, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(a$4, rootName$1, references$1) / this.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(b$4, rootName$1, references$1))
    } else {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((deltaVal < 0)) {
        ...
        var array$1 = [((-$uD(b$2.apply__O())) - (($uD($g["Math"]["sqrt"](deltaVal)) / 2) * $uD(a$2.apply__O()))), ((-$uD(b$2.apply__O())) + (($uD($g["Math"]["sqrt"](deltaVal)) / 2) * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    $m_Lcalculator_Signal$();
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, key$1, value$1) {
      return (function() {
        var this$2 = $m_Lcalculator_Calculator$();
        var expr = $as_Lcalculator_Expr(value$1.apply__O());
        var references = arg$outer.namedExpressions$1$f;
        return this$2.eval$1__p1__Lcalculator_Expr__T__sci_Map__D(expr, key$1, references)
      })
    })(this, key, value));
    var y = new $c_Lcalculator_Signal().init___F0(expr$1);
